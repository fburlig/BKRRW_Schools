************************************************
**** ANALYSIS: MONTHLY REGRESSIONS WITH DONUTS AND SAVINGS
************************************************
...
foreach postctrls in "" "post" {
  foreach blocks in cumul_kwh_binary /* cumul_kwh */ {
...
save "$dirpath_data_int/RESULTS_monthly_savings_DONUTS.dta", replace
