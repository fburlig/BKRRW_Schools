************************************************
**** BUILD ENERGY EFFICIENCY DATA (3 PARTS)
************************************************
...
* import the csv
import excel using "$dirpath_data_raw/PGE_Oct_2016/PGE School Meter Matching to UCB 20161104.xlsx", sheet("All_Match EE") clear firstrow
rename *, lower
...
drop if technology_family == "Audit Information Testing Services"
drop if technology_family == "AUDIT"

replace technology_family = "Building Shell" if technology_family == "Building Shell (Opaque)"
replace technology_family = "Electronics and IT" if technology_family == "Business and Consumer Electronics"
replace technology_family = "Refrigeration" if technology_family == "Chiller" 
replace technology_family = "Refrigeration" if strpos(technology_family, "Refrigerat")
replace technology_family = "Refrigeration" if strpos(technology_family, "REFRIG")
replace technology_family = "Food Service Technology" if technology_family == "Cooking Equipment"
replace technology_family = "HVAC" if strpos(technology_family, "HVAC")
replace technology_family = "Lighting" if strpos(technology_family, "Lighting")
replace technology_family = "Motors, pumps, fans" if strpos(technology_family, "MOTORS")
replace technology_family = "Motors, pumps, fans" if strpos(technology_family, "Pool Pump")
replace technology_family = "Motors, pumps, fans" if strpos(technology_family, "Pool and Spa Equipment")
replace technology_family = "Motors, pumps, fans" if technology_family == "Liquid Circulation"
replace technology_family = "Motors, pumps, fans" if technology_family == "PUMPS AND FANS"
...
** save
save "$dirpath_data_temp/ee_build_dataset_ee_nov5_part1.dta", replace


******* REPEAT FOR CLUSTERS, AND FOR THE OTHER DATA FILE

* import the csv
import excel using "$dirpath_data_raw/PGE_Oct_2016/PGE School Meter Matching to UCB 20161104.xlsx", sheet("Match_Failed_School_NAICS EE") clear firstrow
rename *, lower
...
** only 2 of these? Maybe check with ming.
save "$dirpath_data_temp/ee_build_dataset_ee_nov5_part2.dta", replace
...
* import the csv
import excel using "$dirpath_data_raw/PGE_Oct_2016/UCB SP for EE 20161104.xlsx", sheet("Sheet 1") clear firstrow
rename *, lower
...
** save
save "$dirpath_data_temp/ee_build_dataset_ee_nov5_part3.dta", replace


****** append datasets together
use "$dirpath_data_temp/ee_build_dataset_ee_nov5_part1.dta", clear
append using "$dirpath_data_temp/ee_build_dataset_ee_nov5_part2.dta"
append using "$dirpath_data_temp/ee_build_dataset_ee_nov5_part3.dta"

drop if technology_family == "UNASSIGNED"

duplicates t sp_id measure_code date_stata, gen(dupemeasure)
replace dupemeasure = 0 if dupemeasure == .
duplicates drop

save "$dirpath_data_temp/ee_build_dataset_appended_AUGUST_nov5.dta", replace
